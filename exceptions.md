...
به طور مشابه، اگر برنامۀ شما شامل دستوراتی نا معتبر باشد چه؟ در این حالت، پایتون این وضع را مدیریت می کند؛ یعنی به اصطلاح دست هایش را **بالا می برد** و به شما اعلام می کند که یک **خطا** رخ داده است. 
