...
نرم افزار [LibreOffice](http://www.libreoffice.org/): یک مجموعۀ قدرتمند جامعه محور است که به صورت اداری توسعه می یابد و اجزایی همچون واژه پرداز، نرم افزار، صفحه گسترده و ابزار های ترسیم را در بر می گیرد. این مجموعه حتی می تواند فایل های Microsoft Word و Microsoft Powerpoint را به راحتی باز و ویرایش کند. این نرم افزار بر روی تمامی پلتفرم ها اجرا می شود و یک نرم افزار کاملاً آزاد، لیبر و متن باز محسوب می شود. 
